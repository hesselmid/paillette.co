<script lang="ts">
	...
	const usps = [
		...
		},
		{
			...
			description:
				'Paillette encourages designers to balance traditional handcrafting with digital skills, blending artistry with modern execution. This commitment to both physical and digital techniques ensures that every print is meticulously developed, reflecting both authenticity and innovation.',
			primary: '#D4EBF8',
			secondary: '#EEF7FC'
		},
		{
		...
		},
		{
			...
			description:
				'Each Paillette design is uniquely yours—no duplicates. Upon purchase, you receive high-resolution files and exclusive worldwide rights. Additionally, a certificate of authenticity accompanies each design, reinforcing its originality and value for your brand.',
			primary: '#CDC526',
			secondary: '#EBE8A8'
		}
	];
	...
	const menu = [
		{
			...
			extra: {
				icon: 'star',
				text: 'Conditions: Once sold, the design is taken off the platform and no longer available for purchase.'
			}
		},
		{
		...
		},
		{
			...
			secondary: '#C0BFFF',
			list: [
				'Client collaboration from start to finish, based on a mood-board or a briefing. ',
				'2 client revisions and up to 15 bespoke colorways.',
				'High-resolution files in repeat, with color separations.',
				'Certificate of authenticity for worldwide industrial use for an unlimited time.',
				'Advice on fabric type.'
			],
			extra: {
		...
		},
		{
			...
			secondary: '#ABA9FF',
			list: [
				'Modifying an existing design or altering colorways.',
				'Additional placement designs (e.g. scarf or T-shirt placements).'
			],
			extra: {
				icon: 'plus',
				text: 'Complex Requests: For highly customized or labor intensive changes, fees will be adjusted accordingly (e.g., €500+ depending on the scope).'
			}
		},
		{
			...
			secondary: '#9694FF',
			list: [
				'High-quality behind-the-scenes videos and photos documenting the design process tailored for brands to share on their social media.'
			]
		}
	];
...
<svelte:head>
	<title>Services | Paillette</title>
	<meta
		name="description"
...
<section class="bg-white">
	...
	>
		<div class={['space-y-9 pt-16', 'lg:space-y-12 lg:pt-0 lg:pl-10', 'xl:pl-16', '2xl:pl-20']}>
			...
			>
				Discover a constantly evolving collection with Paillette’s global network of designers,
				bringing you a fluid, always-current selection of exclusive prints. Without the constraints
				of traditional seasons, our collections are updated frequently, letting your brand access
...
<div class={['bg-enoki space-y-16 py-16', 'lg:space-y-20 lg:py-20']}>
	...
	<section>
		...
		>
			{#each menu.slice(0, 3) as item (item.title)}
				<div
					class={[
						'max-w-[340px]',
						'sm:max-w-[570px]',
			...
			<div class="grid gap-y-5">
				{#each menu.slice(3) as item (item.title)}
					<div
						class={[
							'max-w-[340px]',
							'sm:max-w-[570px]',
