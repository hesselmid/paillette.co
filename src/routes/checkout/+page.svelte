...
<form
	method="POST"
	use:enhance
	class="container mx-auto grid grid-cols-1 gap-y-16 bg-white px-4 pt-9 pb-16 md:px-20 lg:grid-cols-2 lg:gap-x-12 lg:px-[66px] lg:pt-12 lg:pb-20 xl:px-[69px] 2xl:px-[197px]"
>
	<!-- Left column -->
	<div class="flex flex-col">
		<section class="pt-9 pb-4">
			<h2 class="font-evolventa text-black-sheep ml-[18px] pb-4 text-2xl/[32px]">
				Contact details
			</h2>
				...
				<div class="border-black-sheep mt-4 border-t pt-4 pb-10">
					<div class="flex flex-col gap-y-4">
						...
						<div class="flex flex-col gap-y-1.5">
							<label
								for="firstName"
								class="font-evolventa text-black-sheep ml-[18px] text-lg/[24px]">First name</label
							>
							<input
								type="text"
								id="firstName"
						...
						<div class="flex flex-col gap-y-1.5">
							<label
								for="vatNumber"
								class="font-evolventa text-black-sheep ml-[18px] text-lg/[24px]">VAT number</label
							>
							<input
								type="text"
								id="vatNumber"
						...
						<div class="flex flex-col gap-y-1.5">
							<label
								for="postalCode"
								class="font-evolventa text-black-sheep ml-[18px] text-lg/[24px]">Postal code</label
							>
							<input
								type="text"
								id="postalCode"
		...
		<section class="flex grow flex-col justify-end">
			...
			<div class="bg-enoki mx-[9px] mt-4">
				...
				<!-- Other payment methods would follow the same pattern -->
				<!-- Mollie -->
